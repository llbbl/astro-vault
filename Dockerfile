...
#     -t astro-vault .
#
# Or let CI/Coolify pass these as build args
...
# Note: No local.db is copied - production uses Turso
# Turso credentials are provided via runtime environment variables
